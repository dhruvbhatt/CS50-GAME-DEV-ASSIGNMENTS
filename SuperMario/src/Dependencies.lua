...
gTextures = {
    ...
    ['lockKey']=love.graphics.newImage('graphics/keys_and_locks.png'),
...
gFrames = {
    ...
    ['lockKey'] = GenerateQuads(gTextures['lockKey'], 16, 16),
    ['post'] = GenerateQuads(gTextures['post'], 16, 64),
    ['flag'] = GenerateQuads(gTextures['flag'], 16, 16)
    --first 4 are keys next 4 are locks
}
