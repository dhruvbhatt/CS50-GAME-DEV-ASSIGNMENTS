...
function Alien:render()
    love.graphics.draw(gTextures['aliens'], gFrames['aliens'][self.sprite],
        ...
        1, 1, 17.5, 17.5)
    --1 are the ratio to its original size, both width and height.
    --17.5 are the half of width and height of the sprite, such that it points to the centre of the sprite and animations and rotation take place about it.
    --if nothing is provided it'll rotate about top left of the sprite and result in weird and incorrect animation.
end